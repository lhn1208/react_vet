...
import imgMain1 from '../images/main/img_main1.jpg';
import imgMain2 from '../images/main/img_main2.jpg';
    ...
    return (
        <>
            {type === "visual" && (
                ...
                >
                    <SwiperSlide><img src={imgMain1} alt="메인 이미지"/></SwiperSlide>
                    <SwiperSlide><img src={imgMain2} alt="메인 이미지"/></SwiperSlide>
                </Swiper>
            )}
